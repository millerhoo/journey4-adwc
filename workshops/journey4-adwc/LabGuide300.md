...
Testing SQL Copy and Paste from HTML to SQL Developer
=====================================================

Section 4. Data Loading
=======================

In this section of the lab, you will be creating sample tables and
loading data into them from files on the Oracle Cloud Infrastructure
Object Storage.
...
Note that you do not need to specify anything other than the list of
columns when creating tables. Also note that all the constraints are
created as RELY DISABLE VALIDATE.
